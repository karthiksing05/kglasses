...
def make_decision():
    print("I see you have a problem.")
    num_options = None
    ...
    print("Great! Now, please list your options to solve the problem, and keep them as generic as possible!")
    options = []
    ...
    for option in options:
        ...
        if condition:
            print("I believe that you should {}".format(lesson))
            break
        else:
            print("I believe that none of these are the best solution. Please look again and see if you can find anything else you can do.")
    time.sleep(1)
    print("Thank you for considering my advice!")
